  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans pb-20">
      ...
      <div className="p-2">
        ...
        <div className="flex items-center p-4 hover:bg-white rounded-3xl transition-all cursor-pointer group">
          <div className="relative">
      ...
      {/* Menú de Navegación Inferior (Sin Gastos) */}
      <div className="fixed bottom-0 w-full bg-white border-t border-gray-100 px-10 py-3 flex justify-between items-center z-50">
        ...
        <Link to="/chats" className="flex flex-col items-center text-blue-600">
          <svg className="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20"><path d="M2 5a2 2 0 012-2h7a2 2 0 012 2v4a2 2 0 01-2 2H9l-3 3v-3H4a2 2 0 01-2-2V5z" /><path d="M15 7v2a4 4 0 01-4 4H9.828l-1.766 1.767c.28.149.599.233.938.233h2l3 3v-3h2a2 2 0 002-2V9a2 2 0 00-2-2h-1z" /></svg>
