  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans pb-24 relative">
      ...
      <div className="mt-16 text-center px-6">
        ...
        <div className="grid grid-cols-2 gap-3 mt-6">
          ...
          >
            ...
            <span className="text-sm">Tengo Vivienda</span>
          </button>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 w-full bg-white border-t border-gray-100 px-6 py-3 flex justify-between items-center z-50">
        ...
        <Link to="/chats" className="flex flex-col items-center text-gray-400 relative">
          <svg className="w-6 h-6 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>
          <span className="text-[10px] font-medium">Chats</span>
        </Link>
        <Link to="/perfil" className="flex flex-col items-center text-blue-600">
          <svg className="w-6 h-6 mb-1" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" /></svg>
