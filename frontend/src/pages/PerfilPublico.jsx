...
const PerfilPublico = (props) => {
  ...
  const manejarClickOfreceVivienda = () => {
    ...
    Maps('/detalle-vivienda/' + usuario.vivienda._id);
  };
    ...
    <div className="min-h-screen bg-gray-50 font-sans pb-24 relative">
      ...
      <div className="mt-16 text-center px-6">
        ...
        <div className="mt-6">
          <Link
            to={`/chat/${userId}`}
            className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-10 rounded-2xl shadow-lg transition-all text-sm w-full max-w-xs active:scale-95"
          >
